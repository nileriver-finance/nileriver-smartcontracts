...
contract ProtocolFeesCollector is IProtocolFeesCollector, Authentication, ReentrancyGuard {
    ...
    uint256 private constant _MAX_PROTOCOL_SWAP_FEE_PERCENTAGE = 80e16; // 80%
    uint256 private constant _MAX_PROTOCOL_FLASH_LOAN_FEE_PERCENTAGE = 2e16; // 2%
    ...
    {
        vault = _vault;
        _flashLoanFeePercentage = 1e16; // 1%
        _swapFeePercentage = 50e16; // 50% protocol fee
    }
