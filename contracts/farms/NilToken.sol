...
contract NilToken is ERC20, Ownable {
    ...
    constructor() ERC20("NileRiver.Finance Token", "NIL") {
        cap =  100000000 ether; // Max Supply: 100 million NIL
        _mint(_msgSender(), 500000 ether); // Prepare: 500000 NIL for liquid
    }
